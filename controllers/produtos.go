...
import (
	...
	"github.com/matheusppaiva/go-list/models"
)
...
func Insert(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		quantindadeConvertido, err := strconv.Atoi(quantidade)
		if err != nil {
			log.Println("Erro na conversão do quantidade:", err)
		}

		models.CriarNovoProduto(nome, descricao, precoConvertido, quantindadeConvertido)
	}
